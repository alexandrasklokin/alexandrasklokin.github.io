...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var why = readData("why");
        var language = readData("language");
        var found = readData("found");
        var useful = readData("useful");
        var rating = readData("rating");
        var overall = readData("overall");
        res.render('showResults', {results: [why,language,found,useful,rating,overall]});
        console.log([why,language,found,useful,rating,overall]);
    });
